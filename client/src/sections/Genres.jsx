        ...
        <div className="grid border-l border-t border-[#c8ff00]/20 md:grid-cols-2">
          {genres.map((genre, index) => (
            <Reveal
              ...
              className="h-full"
            >
              <article className="group relative min-h-[320px] h-full overflow-hidden border-b border-r border-[#c8ff00]/20 bg-[#0b0b0b] p-7 transition-all duration-300 hover:bg-[#101010] md:p-10">
                <div className="absolute right-5 top-5 font-serif text-6xl text-white/[0.035] transition-all duration-300 group-hover:scale-105 group-hover:text-[#c8ff00]/10 md:text-8xl">
                  {genre.number}
                </div>
                ...
                <div className="relative z-10 flex h-full flex-col justify-between">
                  <div>
                    <div className="mb-10 flex items-center justify-between">
                      ...
                      <ArrowUpRight
                        size={20}
                        className="text-neutral-600 transition-all duration-300 group-hover:-translate-y-1 group-hover:translate-x-1 group-hover:text-[#c8ff00]"
                      />
                    </div>
                  ...
                  <p className="mt-10 max-w-md text-sm leading-7 text-neutral-500 transition-colors duration-300 group-hover:text-neutral-300">
                    {genre.description}
                  </p>
                </div>
